...
#Modification of models used in https://github.com/nlpyang/BertSum, introduced in paper https://arxiv.org/pdf/1903.10318.pdf
#Licensed under Apache License 2.0

#This is a simpler version of the encoder relying on pytorch implementations, that can be used when training new models.
...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, key, value, query, mask=None,
        ...
        if mask is not None:
            ...
            #scores = scores.masked_fill(mask, 2e-14)
